...
# ensure whiteteam can log in
Write-Output "Setting whiteteam user file permissions"
New-Item -ItemType Directory -Force -Path "C:\Users\whiteteam\.ssh"
C:\Windows\System32\icacls.exe "C:\Users\whiteteam" /grant "whiteteam:(OI)(CI)F"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\bin" /grant "whiteteam:(OI)RX"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\usr\sbin" /grant "whiteteam:(OI)RX"
...
# disabled for vcloud to make whiteteam-serverspec work
...
Write-Output "Removing ed25519 key as whiteteam net-ssh 2.9.1 does not support it"
...
C:\Windows\System32\icacls.exe "C:\Windows\Temp" /grant "whiteteam:(OI)(CI)F"
...
Set-Content C:\Users\whiteteam\.ssh\environment $sshenv
